...
.controller('paginaHome', function ($scope, $state, Core, $ionicLoading) {
        ...
        /* Função conta clientes  do usuário */
        var todosClientes = function () {
            ...
            query.find({
                success: function (data) {
                    $scope.todosclientes = data.length;
                    //console.log($scope.todosclientes);
                },
